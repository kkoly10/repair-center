const STATUS_MAP = {
  ...
  awaiting_mail_in:    { cls: 'pill pill-pending',  label: 'Awaiting Mail-In' },
  in_transit_to_shop:  { cls: 'pill pill-pending',  label: 'In Transit' },
  ...
  // Org lifecycle statuses
  active:    { cls: 'pill pill-complete', label: 'Active' },
  trialing:  { cls: 'pill pill-pending',  label: 'Trialing' },
  past_due:  { cls: 'pill pill-overdue',  label: 'Past Due' },
  suspended: { cls: 'pill pill-inactive', label: 'Suspended' },
  cancelled: { cls: 'pill pill-inactive', label: 'Cancelled' },
}
